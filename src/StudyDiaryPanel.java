...
public class StudyDiaryPanel extends JPanel {
    ...
    public StudyDiaryPanel(User currUser, UserManagement userManagement,SpotManagement spotManagement) {
        ...
        String[] buttonNames = {"游学日记", "创作日记", "日记推荐", "日记搜索", "Button 5"};
        ...
        JButton buttonName3=new JButton(buttonNames[3]);
        buttonName3.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // 在这里添加你的代码
                // 例如，你可以在这里添加切换到新的 JPanel 的代码
                cardLayout.show(rightPanel, buttonNames[3]);
                // 你也可以添加其他的逻辑，例如打印一条消息
                System.out.println("Button " + buttonName3 + " was clicked");
            }
        });
        leftPanel.add(buttonName3);
        ...
        rightPanel.add(CreateDiaryRecommendationPanel(), "日记推荐");
    ...
    private JPanel CreateDiaryRecommendationPanel() {
        StudyDiaryRecommendationPanel studyDiaryRecommendationPanel = new StudyDiaryRecommendationPanel(studyDiarySystem);
        return studyDiaryRecommendationPanel;
    }
